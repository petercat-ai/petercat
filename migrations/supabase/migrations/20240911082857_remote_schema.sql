...
CREATE TABLE IF NOT EXISTS "public"."bots" (
    ...
    "repo_name" "text",
    "token_id" "text" DEFAULT '''''::text'::"text"
);
...
CREATE TABLE IF NOT EXISTS "public"."user_llm_tokens" (
    "id" "uuid" DEFAULT "gen_random_uuid"() NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "slug" "text",
    "user_id" "text",
...
ALTER TABLE "public"."user_llm_tokens" OWNER TO "postgres";
...
ALTER TABLE ONLY "public"."user_llm_tokens"
    ADD CONSTRAINT "user_llm_tokens_pkey" PRIMARY KEY ("id");
...
GRANT ALL ON TABLE "public"."user_llm_tokens" TO "anon";
GRANT ALL ON TABLE "public"."user_llm_tokens" TO "authenticated";
GRANT ALL ON TABLE "public"."user_llm_tokens" TO "service_role";
