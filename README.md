...
<div  align="center">
  ...
  **专为社区维护者和开发者打造的智能答疑机器人解决方案。**
  ...
  [![DockerHub Version](https://img.shields.io/docker/v/petercatai/petercat)](https://hub.docker.com/r/petercatai/petercat)
...
|  **AWS 相关环境变量** |
| `AWS_REGION` | 必选 |  AWS 部署的 Region | `ap-northeast-1`
